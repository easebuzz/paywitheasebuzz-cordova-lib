                        ...
                        if (EBresponse['flag'] == 0) {
                            if (EBresponse['status'] == "success") {
                                ...
                                if(paymenthash==EBresponse['hash']){
                                    ...
                                    alert("Response hash mismatch");
                                }
                            } else {
                                alert("Failed transaction");
                            }
                        } else {
                            alert(EBresponse['error_status']);
                        }
                    } else {
                        alert("Cancelled/Error transaction");
                    }
                    alert(JSON.stringify(EBresponse));
                    console.log("============= RESPONSE ==========================");
                    console.log(JSON.stringify(EBresponse));
                });
            } else {
